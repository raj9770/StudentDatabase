...
namespace Sem2endsemproject {
	...
	/// Summary for tourism
	/// </summary>
	public ref class tourism : public System::Windows::Forms::Form
	{
	public:
		tourism(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(tourism::typeid));
			...
			this->button7->Click += gcnew System::EventHandler(this, &tourism::button7_Click);
			// 
			// datatable1
			// 
			...
			this->button6->Click += gcnew System::EventHandler(this, &tourism::button6_Click);
			// 
			// button5
			// 
			...
			this->button5->Click += gcnew System::EventHandler(this, &tourism::button5_Click);
			// 
			// button4
			// 
			...
			this->button4->Click += gcnew System::EventHandler(this, &tourism::button4_Click);
			// 
			// button1
			// 
			...
			this->button1->Click += gcnew System::EventHandler(this, &tourism::button1_Click);
			// 
			// button3
			// 
			...
			this->button3->Click += gcnew System::EventHandler(this, &tourism::button3_Click_1);
			// 
			// button2
			// 
			...
			this->button2->Click += gcnew System::EventHandler(this, &tourism::button2_Click);
			// 
			// pictureBox1
			// 
...
private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	db1->dbconn("select * from bvoc.infotosem1", datatable1);
	delete(db1);

}
private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
	dbConnection^ db1 = gcnew dbConnection();
	db1->dbconn("select * from bvoc.infotosem2", datatable1);
	delete(db1);
}
private: System::Void button7_Click(System::Object^ sender, System::EventArgs^ e) {
	dbConnection^ db1 = gcnew dbConnection();
	db1->dbconn("select * from bvoc.infotosem3", datatable1);
	delete(db1);
}
private: System::Void button4_Click(System::Object^ sender, System::EventArgs^ e) {
	dbConnection^ db1 = gcnew dbConnection();
	db1->dbconn("select * from bvoc.infotosem4", datatable1);
	delete(db1);
}
private: System::Void button5_Click(System::Object^ sender, System::EventArgs^ e) {
	dbConnection^ db1 = gcnew dbConnection();
	db1->dbconn("select * from bvoc.infotosem5", datatable1);
	delete(db1);
}
private: System::Void button6_Click(System::Object^ sender, System::EventArgs^ e) {
	dbConnection^ db1 = gcnew dbConnection();
	db1->dbconn("select * from bvoc.infotosem6", datatable1);
	delete(db1);
}
};
}
