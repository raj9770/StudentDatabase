...
namespace Sem2endsemproject {
	...
	public ref class media : public System::Windows::Forms::Form
	{
	public:
		media(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(media::typeid));
			...
			this->button7->Click += gcnew System::EventHandler(this, &media::button7_Click);
			// 
			// button6
			// 
			...
			this->button6->Click += gcnew System::EventHandler(this, &media::button6_Click);
			// 
			// button5
			// 
			...
			this->button5->Click += gcnew System::EventHandler(this, &media::button5_Click);
			// 
			// button4
			// 
			...
			this->button4->Click += gcnew System::EventHandler(this, &media::button4_Click);
			// 
			// button2
			// 
			...
			this->button2->Click += gcnew System::EventHandler(this, &media::button2_Click);
			// 
			// button1
			// 
			...
			this->button1->Click += gcnew System::EventHandler(this, &media::button1_Click);
			// 
			// button3
			// 
			...
			this->button3->Click += gcnew System::EventHandler(this, &media::button3_Click);
			// 
			// tabControl1
			// 
...
private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	db1->dbconn("select * from bvoc.infomdsem1", datatable1);
	delete(db1);
}
private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
	dbConnection^ db1 = gcnew dbConnection();
	db1->dbconn("select * from bvoc.infomdsem2", datatable1);
	delete(db1);
}
private: System::Void button7_Click(System::Object^ sender, System::EventArgs^ e) {
	dbConnection^ db1 = gcnew dbConnection();
	db1->dbconn("select * from bvoc.infomdsem3", datatable1);
	delete(db1);
}
private: System::Void button4_Click(System::Object^ sender, System::EventArgs^ e) {
	dbConnection^ db1 = gcnew dbConnection();
	db1->dbconn("select * from bvoc.infomdsem4", datatable1);
	delete(db1);
}
private: System::Void button5_Click(System::Object^ sender, System::EventArgs^ e) {
	dbConnection^ db1 = gcnew dbConnection();
	db1->dbconn("select * from bvoc.infomdsem5", datatable1);
	delete(db1);
}
private: System::Void button6_Click(System::Object^ sender, System::EventArgs^ e) {
	dbConnection^ db1 = gcnew dbConnection();
	db1->dbconn("select * from bvoc.infomdsem6", datatable1);
	delete(db1);
